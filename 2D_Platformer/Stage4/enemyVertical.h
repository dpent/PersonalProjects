...
class enemyVerticalBlock : public Block
{
public:
   ...
   */
    ...
    enemyVerticalBlock(float x, float y, float w, float h, GameState* m_state)
        : Block(x, y, w, h)
    {
        m_enemies.push_back(m_state->getFullAssetPath("rictaair1.png"));
        m_enemies.push_back(m_state->getFullAssetPath("rictaair2.png"));
        m_enemies.push_back(m_state->getFullAssetPath("rictaair3.png"));
        m_enemies.push_back(m_state->getFullAssetPath("rictaair1.png"));
        m_enemies.push_back(m_state->getFullAssetPath("rictaair2.png"));
        m_enemies.push_back(m_state->getFullAssetPath("rictaair3.png"));
